...
describe 'Bible challenge creation', type: :feature do
  ...
  context 'with valid data' do
    it 'creates a challenge' do
      create_challenge(name: "Some Challenge", subdomain: "somesubdomain", begindate: Date.today, chapterstoread: 'Matthew 1 - 5')
  ...
  context 'with invalid data' do
    ...
    it 'shows an explanation message on invalid dates' do
      create_challenge(name: "Some Challenge", subdomain: "somesubdomain", begindate: Date.today - 1.day, chapterstoread: 'Matthew 1 - 5')
    ...
    it 'shows an explanation message on invalid subdomain' do
      create_challenge(name: "Some Challenge", subdomain: "-", begindate: Date.today, chapterstoread: 'Matthew 1 - 5')
      page.should have_content 'Subdomain invalid format'
    end

    it 'shows an explanation message on invalid name' do
      create_challenge(name: ".", subdomain: "somesubdomain", begindate: Date.today, chapterstoread: 'Matthew 1 - 5')
